...
CHECK_IMPORTS = {
    ...
    "base64": ForbiddenImport(
        ...
        allowed_files={
            ...
            "vllm_omni/protocol/realtime/events.py",
            "vllm_omni/protocol/realtime/items.py",
            ...
            "vllm_omni/model_executor/models/personaplex/duplex/input.py",
            "vllm_omni/model_executor/models/personaplex/duplex/runtime_extension.py",
            "vllm_omni/model_executor/models/personaplex/duplex/stage0.py",
