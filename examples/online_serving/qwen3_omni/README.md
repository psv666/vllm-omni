...
```bash
python examples/online_serving/realtime/openai_realtime_client.py --model Qwen/Qwen3-Omni-30B-A3B-Instruct --image frame.jpg --query "Describe the image." --output audio
```
